...
// ANSWER:   In the first function, the computer is modifying the value of the properties of the "letters" object. Because they start with 0 and increment by however many times each characters repeat in the given string. In the second function, the computer is adding brand new properties of the "letters" object, and subsequently also incrementing the values of those properties. So space complexity is higher for second function.
